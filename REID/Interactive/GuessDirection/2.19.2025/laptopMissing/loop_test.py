...
###IMPORTS INFORMATION FOR BACKGROUND LIBRARIES
import argparse
import os
import sys
import time
...
###OBJECTS AND CLIENT SETUPS & LEASE
...
###MOVEMENT IN SPACE CONTROL        
        # Power on
        robot.logger.info('Powering on robot... This may take several seconds.')
        robot.power_on(timeout_sec=20) # The amount of time alotted to allow robot to respond to robot
        ...
        time.sleep(3) # Measured in seconds
        ...
        flat_body_T_pose2 = math_helpers.SE3Pose(x=0.0, y=0, z=0, rot=math_helpers.Quat(w=0.0, x=0.075, y=0, z=0))
